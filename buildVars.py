...
addon_info = {
	...
	"addon_name": "captchaAssistant",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Captcha Assistant"),
	# Add-on description
	...
	"addon_version": "0.0.1",
	# Author(s)
	"addon_author": "hwf1324 <1398969445@qq.com>, wingSkyG <1392004426@qq.com>, ferryboy001 <tianci_1080@qq.com>, indianmifanss <1211328584@qq.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/hwf1324/captchaAssistant",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/hwf1324/captchaAssistant",
